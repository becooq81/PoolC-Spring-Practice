...
public final class Message {
    ...
    public static final String SUCCESSFUL_SIGNUP_ACTIVITY = "You have successfully signed up for this activity.";
    public static final String SUCCESSFUL_SIGNUP_REQUEST = "You have successfully requested signup.";
